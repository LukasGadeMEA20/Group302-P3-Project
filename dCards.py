...
def draw_results(image, qCard):
    ...
    #cv2.putText(image,(rank_name+' of'),(x-60,y-10),1,(0,0,0),3,cv2.LINE_AA)
    
    #cv2.putText(image,(rank_name+' of'),(x-60,y-10),1,(50,200,200),2,cv2.LINE_AA)

    #cv2.putText(image,suit_name,(x-60,y+25),1,(0,0,0),3,cv2.LINE_AA)
    #cv2.putText(image,suit_name,(x-60,y+25),1,(50,200,200),2,cv2.LINE_AA)

    cv2.putText(image, 'hej', (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 1, cv2.LINE_AA)
